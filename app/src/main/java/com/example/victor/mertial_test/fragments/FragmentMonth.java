...
public class FragmentMonth extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(R.layout.fragment_fragment_month, container, false);
...
//            }
//        }
        valueSet1.add(new BarEntry(561, 0));
        valueSet1.add(new BarEntry(7851, 1));
        valueSet1.add(new BarEntry(451, 2));
        valueSet1.add(new BarEntry(4651, 3));
        valueSet1.add(new BarEntry(5674, 4));
        valueSet1.add(new BarEntry(1352, 5));
        valueSet1.add(new BarEntry(7892, 6));
        valueSet1.add(new BarEntry(8712, 7));
        valueSet1.add(new BarEntry(2376, 8));
        valueSet1.add(new BarEntry(10842, 9));
        valueSet1.add(new BarEntry(0, 10));
        valueSet1.add(new BarEntry(0, 11));
...
//        }
        ...
        yVals1.add(new Entry(1, 1));
        yVals1.add(new Entry(1, 2));
        yVals1.add(new Entry(1, 3));
        yVals1.add(new Entry(0, 4));
        yVals1.add(new Entry(1, 5));
        yVals1.add(new Entry(0, 6));
        yVals1.add(new Entry(2, 7));
        yVals1.add(new Entry(1, 8));
        yVals1.add(new Entry(1, 9));
...
//        }
        ...
        yVals1.add(new Entry(1, 6));
        yVals1.add(new Entry(3, 7));
        yVals1.add(new Entry(1, 8));
        yVals1.add(new Entry(2, 9));
        yVals1.add(new Entry(0, 10));
        yVals1.add(new Entry(0, 11));
